...
async function transformSchemaA(inputFile) {
    ...
    return new Promise((resolve, reject) => {
        ...
        // Output file name will automatically match input file
        ...
        fs.createReadStream(inputFile)
            ...
            .on("end", async () => {
                ...
                try {
                    ...
                    console.log("Schema A Transformation Completed");
...
module.exports = transformSchemaA;